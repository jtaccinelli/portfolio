...
export function Footer() {
  ...
  return (
    <div className="grid grid-cols-1 gap-16 bg-red-700 px-8 py-24 pb-32 md:grid-cols-3 md:px-24">
      <div className="flex flex-col space-y-2">
        <p className="text-red-400">Connect</p>
      ...
      <div className="flex flex-col space-y-2">
        <p className="text-red-400">Boring Stuff</p>
      ...
      <div className="flex flex-col space-y-2">
        <p className="text-red-400">Acknowledgment</p>
